    ...
    extend: {
      colors: {
        ...
        secondary: {
          ...
          300: "#fdba74",
          400: "#fb923c",
          500: "#ff9f00", // Flipkart Yellow/Orange
          600: "#ea580c",
          700: "#c2410c",
          800: "#9a3412",
          900: "#7c2d12",
      ...
      boxShadow: {
        ...
        "soft-xl":
          "0 20px 60px -10px rgba(0, 0, 0, 0.15), 0 30px 40px -5px rgba(0, 0, 0, 0.08)",
        // Colored shadows
        "primary-lg": "0 10px 40px -10px rgba(14, 165, 164, 0.3)",
        "secondary-lg": "0 10px 40px -10px rgba(124, 58, 237, 0.3)",
        // Inner shadows
